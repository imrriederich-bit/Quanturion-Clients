...
export function calculateTax(input, options = {}) {
...
export function calculateMortgage(input, options = {}) {
...
export function calculateElectricity(input, options = {}) {
...
export function calculateInsurance(input, options = {}) {
...
export function calculateModule(moduleKey, input, options = {}) {
  switch (moduleKey) {
